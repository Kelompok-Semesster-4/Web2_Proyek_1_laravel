               ...
               @else
                  @foreach ($heroImages as $i => $img)
                     <div class="carousel-item {{ $i == 0 ? 'active' : '' }}">
                        <img src="{{ asset('storage/uploads/ruangan/' . $img->foto) }}" class="d-block w-100"
                     ...
                     @foreach ($ruangan as $r)
                        ...
                        <div class="room-item">
                           ...
                           <div class="room-card">
                              ...
                              <div class="room-img">
                                 <img
                                    src="{{ !empty($fotoRuangan) ? asset('storage/uploads/ruangan/' . $fotoRuangan) : asset('assets/icons/logo_big.svg') }}"
                                    alt="{{ $r->nama_ruangan }}">
                              </div>
