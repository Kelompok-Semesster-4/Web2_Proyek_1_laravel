<x-layouts.admin-layout>
    <x-slot:title>Kelola Gedung - Admin</x-slot>

        <div class="admin-container" style="max-width: 100%;">
            <!-- Page Header -->
            <x-head-title-admin title="Kelola Gedung" icon="bi bi-building" buttonText="Tambah Gedung"
                modalTarget="#modalAddGedung" />
            <!-- Alert Messages -->
            <x-alert-admin entity="Gedung" />

            <!-- Card Tabel Gedung -->
            <x-table-card title="Daftar Gedung" icon="bi bi-building" table-id="tableGedung"
                search-placeholder="Cari gedung..." :total="count($gedungs)" total-label="gedung terdaftar"
                :empty="empty($gedungs)" empty-title="Belum ada data gedung"
                empty-subtitle="Tambahkan gedung pertama Anda" :colspan="5" body-max-height="420px" :sticky-head="true">
                <x-slot name="head">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1 justify-content-center">
                                <button type="button" class="btn btn-info aksi-btn"
                                ...
                                <form action="{{ route('admin.gedung.destroy', $gedung->id) }}" method="POST"
                                    class="d-inline" id="formDelete{{ $gedung->id }}">
                                    @csrf
                                    @method('DELETE')

                                    <button type="button" class="btn btn-danger aksi-btn"
                                        style="min-width: 65px; font-size: 0.8rem;"
            ...
            <!-- Modal Add Gedung -->
            <x-modal-admin id="modalAddGedung" title="Tambah Gedung Baru" icon="bi bi-plus-circle-fill">
                <form action="{{ route('admin.gedung.store') }}" method="POST">
                    ...
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="addNamaGedung" name="nama_gedung"
                                maxlength="100" required placeholder="Contoh: Gedung A">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="addJumlahLantai" name="jumlah_lantai" min="1"
                                required placeholder="Contoh: 3">
                            <small class="text-muted">Lantai akan dibuat otomatis (contoh: isi 3 = dibuatkan lantai 1,
                                2, 3)</small>
                        </div>
                    </div>
                ...
                <form action="{{ route('admin.gedung.update', '__ID__') }}" method="POST" id="formEditGedung">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="editJumlahLantai" name="jumlah_lantai" min="1"
                                required placeholder="Contoh: 3">
                            <small class="text-muted text-warning"><i class="bi bi-exclamation-triangle-fill"></i>
                                Mengurangi jumlah lantai akan menghapus lantai atas jika belum ada ruangan.</small>
                        </div>
                    </div>
                    <div class="modal-footer border-0 pt-0">
            ...
            <!-- Modal Detail Gedung -->
            <x-modal-admin id="modalViewDetailGedung" title="Detail Gedung" icon="bi bi-eye-fill"
            ...
            @push('scripts')
                ...
                <script>
                    ...
                    <div style="text-align:center; padding-top: 6px;">
                        ...
                        <h2 style="margin:0 0 12px; font-size:28px; font-weight:800; line-height:1.2; color:#0f172a;">Hapus Gedung?</h2>
                        <p style="margin:0; font-size:17px; line-height:1.6; color:#475569;">
                            Gedung "${escapeHtml(namaGedung)}" akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.
                        </p>
                    </div>
                `,
                            width: 390,
