<x-layouts.admin-layout>
    <x-slot:title>Kelola Ruangan - Admin</x-slot>
        ...
        <div class="admin-container" style="max-width: 100%;">
            <!-- Page Header -->
            <x-head-title-admin title="Kelola Ruangan" icon="bi bi-house-up" buttonText="Tambah Ruangan"
                modalTarget="#modalAddRuangan" />
            <!-- Alert Messages -->
            <x-alert-admin entity="Ruangan" />

            <!-- Card Tabel Ruangan -->
            <x-table-card title="Daftar Ruangan" icon="bi bi-door-open" table-id="tableRuangan"
                search-placeholder="Cari ruangan, gedung..." :total="count($ruangans)" total-label="ruangan terdaftar"
                :empty="$ruangans->isEmpty()" empty-title="Belum ada data ruangan"
                empty-subtitle="Tambahkan ruangan pertama Anda" :colspan="7" body-max-height="420px"
                :sticky-head="true">
                <x-slot name="head">
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1 justify-content-center ruangan-actions">
                                ...
                                <form action="{{ route('admin.ruangan.destroy', $ruangan->id) }}" method="POST"
                                    class="d-inline" id="formDelete{{ $ruangan->id }}">
                                    @csrf
                                    @method('DELETE')
            ...
            <x-modal-admin id="modalAddRuangan" title="Tambah Ruangan Baru" icon="bi bi-plus-circle-fill"
                    ...
                    <div class="modal-body p-3">
                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input type="file" class="form-control" name="foto_cover" accept="image/*"
                                    id="addCoverInput" onchange="previewAddCover(event)">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_ruangan" id="editNamaRuangan"
                                    required>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="fasilitas-item">
                                                <input class="form-check-input edit-fasilitas-checkbox" type="checkbox"
                                                    name="fasilitas_ids[]" value="{{ $f->id }}" id="editFasilitas{{ $f->id }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" name="foto_cover" accept="image/*"
                                id="editCoverFile" onchange="previewEditCover(event)">
                            <small class="text-muted">
            ...
            <!-- Modal View Detail -->
            <x-modal-admin id="modalViewDetail" title="Detail Ruangan" icon="bi bi-eye-fill"
            ...
            <!-- Modal View Image -->
            <x-modal-admin id="modalViewImage" title="Foto Ruangan" title-id="viewImageTitle" icon="bi bi-images"
                header-gradient="#212529" dialog-class="modal-dialog modal-dialog-centered modal-lg"
