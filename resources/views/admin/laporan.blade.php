    ...
    <x-slot:title>Laporan - Admin</x-slot>
        ...
        <div class="admin-container" style="max-width:100%;">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-3">
                    <div class="stat-card-slim bg-primary text-white p-3 rounded shadow-sm text-center">
                        <div class="stat-card-header"><span class="stat-value fw-bold fs-3">{{ $totalRequests }}</span>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="stat-card-slim bg-success text-white p-3 rounded shadow-sm text-center">
                        <div class="stat-card-header"><span
                                class="stat-value fw-bold fs-3">{{ number_format($approvalRate, 1) }}%</span></div>
                ...
                <div class="col-md-3">
                    <div class="stat-card-slim bg-danger text-white p-3 rounded shadow-sm text-center">
                        <div class="stat-card-header"><span
                                class="stat-value fw-bold fs-3">{{ number_format($rejectionRate, 1) }}%</span></div>
                ...
                <div class="col-md-3">
                    <div class="stat-card-slim bg-info text-white p-3 rounded shadow-sm text-center">
                        <div class="stat-card-header"><span class="stat-value fw-bold fs-4">{{ $avgDurasi }}</span>
                        </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-lg-8">
                    <x-table-card title="Most Used Rooms" icon="bi bi-star-fill" :show-search="false"
                        :total="count($topRuangan)" total-label="ruangan terdata" :empty="empty($topRuangan)"
                        empty-title="Tidak ada data" empty-subtitle="Data penggunaan ruangan belum tersedia"
                        :colspan="4">
                        <x-slot name="head">
                            <tr>
            ...
            <x-table-card title="Detail Transaction Table" icon="bi bi-list-check" table-id="tableLaporan"
                :total="count($detail)" total-label="transaksi ditemukan" :empty="empty($detail)"
                empty-title="Tidak ada data transaksi" empty-subtitle="Coba sesuaikan filter pencarian Anda"
                :colspan="10">
