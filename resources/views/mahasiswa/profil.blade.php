        ...
        <div class="container">
            ...
            <div class="profil-sidebar">
                <div class="avatar-container">
                    <div class="avatar">
                        <img id="avatarPreview" src="{{ $profilePhotoUrl ?? '' }}" alt="Foto Profil" class="{{ $profilePhotoUrl ? '' : 'd-none' }}">
                        <span id="avatarInitial" class="avatar-initial {{ $profilePhotoUrl ? 'd-none' : '' }}">{{ $profileInitial }}</span>
                    </div>
                </div>
                ...
                <div class="user-info">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">{{ $user->created_at->locale('id')->format('F Y') ?? 'N/A' }}</div>
                    </div>
                </div>
            </div>
                ...
                <div class="profil-forms">
                    ...
                    <!-- Ubah Password -->
                        <div class="form-section">
                            ...
                            <div class="form-group" id="currentPasswordGroup" @if (!$user->password) style="display: none;" @endif>
