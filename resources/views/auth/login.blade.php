          ...
          <div x-show="view === 'register'" x-transition x-cloak>
            ...
            <form action="{{ route('register') }}" method="post" autocomplete="off">
              ...
              <div class="field">
                ...
                <input type="text" name="username" id="username_register" class="input" placeholder="Masukkan username"
                  required autofocus>
              </div>
              ...
              <div class="field">
                ...
                <input type="password" name="password_confirmation" id="pwconf" class="input"
